...
int main(int argc, char * argv[])
{
    ...
    // our gl stuff
    //NGLDraw ngl;
    StateManager stateManager(rect.w, rect.h);
    ...
    {
        //Print elapsed time
        //std::cout << "Elapsed Time: " << GameTimer.GetTime() << std::endl;
        ...
        while ( SDL_PollEvent(&event) )
        {
            ...
            case SDL_MOUSEMOTION : stateManager.mouseMoveEvent(event.motion); break;
            case SDL_MOUSEBUTTONDOWN : stateManager.mousePressEvent(event.button);  GameTimer.Reset(); break;
            case SDL_MOUSEBUTTONUP : stateManager.mouseReleaseEvent(event.button); break;
            case SDL_MOUSEWHEEL : stateManager.wheelEvent(event.wheel); break;
                //case SDL_KEYDOWN : ngl.keyboardPressEvent(event);
            ...
            case SDL_WINDOWEVENT :
                ...
                // now we look for a keydown or up event
            case SDL_KEYDOWN:
                //ngl.keyboardPressEvent(event);
                stateManager.keyboardPressEvent(event);

            {
                ...
                case SDLK_y : glPolygonMode(GL_FRONT_AND_BACK,GL_LINE); break;
                case SDLK_h : glPolygonMode(GL_FRONT_AND_BACK,GL_FILL); break;
                case SDLK_f :
